...
contract Fundraiser is Ownable {
    ...
    // ============================= CONTRACT VARIABLES ==============================
    // change before live deployment
    
    // deposit token contract address
    address public constant TRUSTED_DEPOSIT_TOKEN_ADDRESS = address(0);
    address public constant TRUSTED_REWARD_TOKEN_ADDRESS = address(0);
    
    uint public constant REWARD_TOKEN_PER_DEPOSIT_TOKEN = 1e18;
    uint public constant DEPOSIT_TOKEN_DECIMALS = 6;
    uint public constant FUNDRAISER_GOAL_IN_DEPOSIT_TOKENS = 1000e6;
    uint public constant CHAIN_ID = 4; // 4 = rinkeby, 1 = eth mainnet
